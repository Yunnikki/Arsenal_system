...
{WBK_OB_KitDescriptionActual = OB_Description_Text_ORDINAL; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_Grunt; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_Wallhammer; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_APF; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
};
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_HL2ORDINAL; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_HL2Combine; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; removeGoggles player; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
...
{WBK_OB_KitDescriptionActual = OB_Description_Text_CivilProtection; player setVariable ['SFX_R_DisableDyingSounds',1,true]; player setSpeaker 'NoVoice';player disableAI 'RADIOPROTOCOL'; [player, 'WBK_CombineHead'] remoteExec ['setFace', 0, true];}
] spawn Wbk_AddKitFromUnitEquipment;
